...
const Register = () => {
  ...
  const userRegister = async () => {
    const response = await axios.post("https://day41taskbe-1.onrender.com/user/register", { username, email, password });
  ...
  return (
    <div className='d-flex flex-column justify-content-center align-items-center' style={{ width: "100vw" }}>
      <form className='border border-5 p-5' style={{ borderRadius: "25px" }} onSubmit={handleSubmit}>
        <h1>Register Page</h1>
        <div className='mt-5'>
